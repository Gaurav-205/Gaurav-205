...
<table>
  <tr>
    <td valign="top"><img src="./gaurav-ascii.svg" width="370" /></td>
...
- **`gaurav-ascii.svg`**: A self-typing ASCII art portrait of my profile avatar, rendered row-by-row with individual SMIL clip-path animations and an animated command cursor.
...
*Automatically updated every day at 06:17 UTC via GitHub Actions.*
